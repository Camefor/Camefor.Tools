...
namespace Camefor.Tools.NetCore.Util
{
    ...
    public static class DirFileHelper
    {
        ...
        public static void DeleteDir(string dir)
        {
            if (dir.Length == 0) return;
            if (Directory.Exists(AppDomain.CurrentDomain.BaseDirectory + "\\" + dir))
                Directory.Delete(AppDomain.CurrentDomain.BaseDirectory + "\\" + dir);
        }
        #endregion
        ...
        public static void CreateFile(string dir, string pagestr)
        {
            ...
            System.IO.StreamWriter sw = new System.IO.StreamWriter(AppDomain.CurrentDomain.BaseDirectory + "\\" + dir, false, System.Text.Encoding.GetEncoding("utf-8"));
            sw.Write(pagestr);
            sw.Close();
        }
        /// <summary>
        ...
        {
            if (System.IO.File.Exists(AppDomain.CurrentDomain.BaseDirectory + file))
            {
                System.IO.File.Delete(AppDomain.CurrentDomain.BaseDirectory + file);
            }
        }
        /// <summary>
        /// 删除文件
        ...
        public static void MoveFile(string dir1, string dir2)
        {
            dir1 = dir1.Replace("/", "\\");
            dir2 = dir2.Replace("/", "\\");
            if (System.IO.File.Exists(AppDomain.CurrentDomain.BaseDirectory + "\\" + dir1))
                System.IO.File.Move(AppDomain.CurrentDomain.BaseDirectory + "\\" + dir1, AppDomain.CurrentDomain.BaseDirectory + "\\" + dir2);
        }
        #endregion
        ...
        public static void CopyFile(string dir1, string dir2)
        {
            ...
            if (System.IO.File.Exists(AppDomain.CurrentDomain.BaseDirectory + "\\" + dir1))
            {
                System.IO.File.Copy(AppDomain.CurrentDomain.BaseDirectory + "\\" + dir1, AppDomain.CurrentDomain.BaseDirectory + "\\" + dir2, true);
            }
        }
        #endregion
